...
class datatype
{
    ...
    [
        ...
        'string'          => ['min' => 1,  'max' => 10000000, 'validator' => '.+'],
        'string:optional' => ['min' => 0,  'max' => 10000000, 'validator' => '.*'],
        'text'            => ['min' => 1,  'max' => 10000000, 'validator' => '[\s\S]+'],
        'text:optional'   => ['min' => 0,  'max' => 10000000, 'validator' => '[\s\S]*'],
        'email'           => ['min' => 6,  'max' => 100,      'validator' => '[\w\-\.]+@[\w\-\.]+'],
        'object'          => ['min' => 2,  'max' => 10000],
        'array'           => ['min' => 2,  'max' => 10000]
    ];
}
