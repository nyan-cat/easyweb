...
class datatype
{
    ...
    [
        ...
        'string'          => ['min' => 1,  'max' => 100000, 'validator' => '.+'],
        'string:optional' => ['min' => 0,  'max' => 100000, 'validator' => '.*'],
        'text'            => ['min' => 1,  'max' => 500000, 'validator' => '[\s\S]+'],
        'text:optional'   => ['min' => 0,  'max' => 500000, 'validator' => '[\s\S]*'],
